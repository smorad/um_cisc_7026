...
#slide[
  *Task:* Given an pictures of clothes, predict their text descriptions #pause
  ...
  $X: #image("figures/lecture_5/classify_input.svg", width: 80%)$ #pause
  ...
  *Approach:* Learn the parameters $theta$ that produce *class probabilities*  #pause
  ...
  $ f(x, theta) = P(y | x) = P("boot" | #image("figures/lecture_5/shirt.png", height: 20%)) $ #pause
]
...
#slide[
  ...
  $ f(bold(x), bold(theta)) = P(bold(y) mid(|) bold(x)) =
    P(vec("boot", "dress", dots.v) mid(|) #image("figures/lecture_5/shirt.png", height: 20%)) $ #pause
]
